...
public class TransactionMetadata {
  ...
  public TransactionMetadata failure(@javax.annotation.Nullable Failure failure) {
   ...
   * @return the TransactionMetadata instance itself
   */
  public TransactionMetadata putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.failure, transactionMetadata.failure)&&
        Objects.equals(this.additionalProperties, transactionMetadata.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(failure, additionalProperties);
  }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<TransactionMetadata>() {
           ...
           public TransactionMetadata read(JsonReader in) throws IOException {
             ...
             TransactionMetadata instance = thisAdapter.fromJsonTree(jsonObj);
