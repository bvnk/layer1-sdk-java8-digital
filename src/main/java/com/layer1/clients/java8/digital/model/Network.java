...
public class Network {
  ...
  public static final String SERIALIZED_NAME_NATIVE_ASSET = "nativeAsset";
  @SerializedName(SERIALIZED_NAME_NATIVE_ASSET)
  @javax.annotation.Nullable
  ...
  @javax.annotation.Nullable
  private List<Asset> supportedAssets = new ArrayList<>();

  public static final String SERIALIZED_NAME_TAG_SUPPORTED = "tagSupported";
  @SerializedName(SERIALIZED_NAME_TAG_SUPPORTED)
  @javax.annotation.Nullable
  private Boolean tagSupported = false;

  public Network() {
  }

  public Network network(@javax.annotation.Nullable String network) {
  ...
  public Network nativeAsset(@javax.annotation.Nullable String nativeAsset) {
  ...
  public void setNativeAsset(@javax.annotation.Nullable String nativeAsset) {
    this.nativeAsset = nativeAsset;
  }


  public Network supportedAssets(@javax.annotation.Nullable List<Asset> supportedAssets) {
    this.supportedAssets = supportedAssets;
    return this;
  }

  public Network addSupportedAssetsItem(Asset supportedAssetsItem) {
   ...
   */
  @javax.annotation.Nullable
  public List<Asset> getSupportedAssets() {
    return supportedAssets;
  }

  public void setSupportedAssets(@javax.annotation.Nullable List<Asset> supportedAssets) {
    this.supportedAssets = supportedAssets;
  }


  public Network tagSupported(@javax.annotation.Nullable Boolean tagSupported) {
    this.tagSupported = tagSupported;
    return this;
  }
  ...
  public void setTagSupported(@javax.annotation.Nullable Boolean tagSupported) {
    this.tagSupported = tagSupported;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.network, network.network) &&
        Objects.equals(this.nativeAsset, network.nativeAsset) &&
        Objects.equals(this.supportedAssets, network.supportedAssets) &&
        Objects.equals(this.tagSupported, network.tagSupported)&&
        Objects.equals(this.additionalProperties, network.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(network, nativeAsset, supportedAssets, tagSupported, additionalProperties);
  }
  ...
  public String toString() {
    ...
    sb.append("    tagSupported: ").append(toIndentedString(tagSupported)).append("\n");
  ...
  static {
    ...
    openapiFields.add("nativeAsset");
    openapiFields.add("supportedAssets");
    openapiFields.add("tagSupported");
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("nativeAsset") != null && !jsonObj.get("nativeAsset").isJsonNull()) && !jsonObj.get("nativeAsset").isJsonPrimitive()) {
        throw new IllegalArgumentException(String.format("Expected the field `nativeAsset` to be a primitive type in the JSON string but got `%s`", jsonObj.get("nativeAsset").toString()));
      }
      if (jsonObj.get("supportedAssets") != null && !jsonObj.get("supportedAssets").isJsonNull()) {
        JsonArray jsonArraysupportedAssets = jsonObj.getAsJsonArray("supportedAssets");
        if (jsonArraysupportedAssets != null) {
          ...
          for (int i = 0; i < jsonArraysupportedAssets.size(); i++) {
            Asset.validateJsonElement(jsonArraysupportedAssets.get(i));
          };
        }
      }
  }
