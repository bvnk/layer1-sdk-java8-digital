...
public class ApiError {
  ...
  public ApiError status(@javax.annotation.Nullable String status) {
    this.status = status;
    return this;
  }
  ...
  public ApiError details(@javax.annotation.Nullable Detail details) {
  ...
  public void setDetails(@javax.annotation.Nullable Detail details) {
    this.details = details;
  }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(code, status, message, details, additionalProperties);
  }
  ...
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("details") != null && !jsonObj.get("details").isJsonNull()) {
        Detail.validateJsonElement(jsonObj.get("details"));
      }
  }
